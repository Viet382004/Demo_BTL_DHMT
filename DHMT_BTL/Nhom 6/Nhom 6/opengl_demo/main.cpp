...
void phongchinh(float x, float y, float z, int goc)
{
	...
	TuongBen(15.0, 5.0, -25.0, 0.2, 4.0, 10.0); // Tường phía trên cửa sổ 1
	TuongBen(15.0, 5.0, -5.0, 0.2, 4.0, 10.0);  // Tường phía trên cửa sổ 2
	TuongBen(15.0, 5.0, 15.0, 0.2, 4.0, 10.0); // Tường phía trên cửa sổ 3

	// Phần tường dưới của cửa sổ 1
	TuongBen(15.0, -5.0, -25.0, 0.2, 4.0, 10.0); // Tường phía dưới cửa sổ 1
	TuongBen(15.0, -5.0, -5.0, 0.2, 4.0, 10.0);  // Tường phía dưới cửa sổ 2
	TuongBen(15.0, -5.0, 15.0, 0.2, 4.0, 10.0); // Tường phía dưới cửa sổ 3

	TuongBen(15.0, 0.0, -33.0, 0.2, 14.0, 6.0); // Giữa dau và cửa sổ 1
	TuongBen(15.0, 0.0, -15.0, 0.2, 14.0, 10.0); // Giữa cửa sổ 1 và cửa sổ 2
	TuongBen(15.0, 0.0, 5.0, 0.2, 14.0, 10.0);  // Giữa cửa sổ 2 và cửa sổ 3
	TuongBen(15.0, 0.0, 23.0, 0.2, 14.0, 6.0); // Giữa cửa sổ 3 và cuoi

	// Các tường bên khác
	TuongBen(-15.0, 0.0, -4.25, 0.2, 14.0, 4.5); // Phần tường bên phải
	TuongBen(-15.0, 0.0, -5.5, 0.2, 14.0, 40);
...
{
	mat4 instance = identity_mat4();
	instance = translate(vec3(x, y, z)) * scale(vec3(13.5, 8.0, 0.1)); // Nền bảng (kích thước 8x4)
